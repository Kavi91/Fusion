...
class Parameters():
	def __init__(self):
		...
		self.pretrained_flownet = '/home/kavi/DeepVO-pytorch/FlowNet_models/pytorch/flownets_bn_EPE2.459.pth'
								# Choice:
								# None
		...
		self.load_model_path = 'models/t{}_v{}_im{}x{}_s{}x{}_b{}_rnn{}_{}_best.pth'.format(
					''.join(self.train_video), ''.join(self.valid_video), self.img_h, self.img_w,
					self.seq_len[0], self.seq_len[1], self.batch_size, self.rnn_hidden_size,
